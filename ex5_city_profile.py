...
def main():
    ...
    path_data = "M:/OpenSourceGIS_exercise5-master/OpenSourceGIS_exercise5-master/data"
    ...
    # Answers for 2) mean: 705.02, min: 558, max: 980
    ...
    gscript.run_command('v.in.ogr', input =path_bars_reprojected, layer='osm_bars' output='bars' where="tourism='bars'")
